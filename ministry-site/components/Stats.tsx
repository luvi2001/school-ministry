...
const milestones = [
  ...
  { year: '2025', event: 'Established 15 Bible Study Groups across 4 areas (Kirupana, Wellawatta, Dematagoda, and wattala), led by the trained leaders, strengthening consistent engagement and spiritual growth.' },
    ...
    <section id="stats" className="py-24 bg-white" ref={sectionRef}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-accent/30 shadow-2xl shadow-accent/20 mt-8 h-100 md:h-96 bg-secondary/5">
