      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={ref} className="animate-on-scroll text-center mb-16">
          ...
          <p className="text-secondary/70 text-lg leading-relaxed max-w-3xl mx-auto">
            The School Ministry (SM) is a ministry of Youth for Christ (YFC) under the West Zone, sharing in the vision of seeing every young person have the opportunity to make an informed decision to be a follower of Jesus Christ and become part of the local church.
            <br /><br />
            As part of Youth for Christ's mission to reach young people everywhere and raise lifelong followers of Jesus Christ, the School Ministry focuses on engaging school students through meaningful relationships and relevant programs. Through tuition classes, monthly worship nights, sports events, outreach initiatives, and discipleship gatherings, we create opportunities for students to encounter Christ, grow in their faith, and discover God's purpose for their lives.
            <br /><br />
            By meeting students where they are and walking alongside them in their spiritual journey, we seek to raise a generation of young people who know Jesus, live for Him, and influence their schools, families, and communities for His glory. As a ministry under the YFC West Zone, we are committed to reaching students across our communities and helping them develop a lifelong relationship with Jesus Christ.
          </p>
        </div>
        ...
        <div ref={useScrollReveal()} className="animate-on-scroll mt-20">
          <h3 className="font-display text-3xl text-stone-800 mb-8 font-medium text-center">Our Ministry in Action</h3>
