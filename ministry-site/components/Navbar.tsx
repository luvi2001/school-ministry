    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="#hero" className="flex items-center gap-4 group">
          ...
          <div>
            <p className="font-display text-white font-semibold text-2xl uppercase leading-none">Colombo School Ministry</p>
            <p className="text-accent text-xl tracking-widest  leading-none mt-4">Youth For Christ</p>
          </div>
        </a>
