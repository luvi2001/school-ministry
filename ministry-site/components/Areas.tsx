...

{
  ...
  tag: 'Since 2022',
  description:
    'A central Colombo hub and main ministry center. This area hosts sports activities, tuition classes, weekly Bible studies, and major fellowship events. It serves as a key gathering point for youth engagement and discipleship.',
  focus: ['Sports Ministry', 'Tuition Classes', 'Bible Studies', 'Main Events'],
  youths: 28,
  groups: 7,
...

{
  ...
  tag: 'Since 2020',
  description:
    'A growing coastal suburb where youth ministry is expanding rapidly. We focus on Bible studies and strong sports engagement, with a particularly active group of girls excelling in sports and youth fellowship activities.',
  focus: ['Bible Studies', 'Sports Engagement', 'Youth Fellowship'],
  youths: 12,
  groups: 4,
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={headerRef} className="animate-on-scroll text-center mb-16">
          ...
          <h2 className="font-body text-5xl md:text-6xl font-light text-primary mb-4">
            Our <em className="text-accent not-italic font-medium">Areas</em>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {areas.map((area, i) => {
            ...
            return (
              ...
              >
                {/* Card header */}
                <div className={`bg-gradient-to-br ${area.color} p-7 h-80 relative overflow-hidden80`}>
                  ...
                  {/* Quick stats */}
                  <div className="flex gap-8 mt-8 relative z-10 justify-center">
                    ...
                    <div className="text-center px-6 py-4 bg-white/10 rounded-xl border border-white/20 backdrop-blur-sm">
                      ...
                      <p className="text-white/70 text-xs tracking-wide uppercase mt-1">Bible Study Groups</p>
                    </div>
                  </div>
                </div>
